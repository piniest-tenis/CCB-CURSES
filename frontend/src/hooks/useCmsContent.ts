...
export const INTERSTITIAL_FALLBACKS: CmsContent[] = [
  ...
  },
  {
    ...
    body: "Comprised of four internal orders — The Hospitallers, The Medicaments, The Etherements, and The Tenders — the Hygiane Order tends the corruption of Forestdown. Now at its weakest in living memory, the Order receives its dwindling annual tribute of volunteers from the Varjalune Republic.",
    imageKey: null,
    imageUrl: null,
    active: true,
    order: 3,
  ...
  },
  {
    ...
    type: "interstitial",
    title: "The Creep",
    body: "The ever-present corrupting factor within Forestdown. The Creep describes both the rotted undergrowth that marks ground claimed by the forest and all the numerous lifeforms that reside within it. Distinct from the Etherotaxia — the spirits and semi-corporeal beings that also inhabit Forestdown.",
    imageKey: null,
    imageUrl: null,
    active: true,
    order: 4,
  ...
  },
  {
    ...
    body: "An ancient ghost, old even before the first age. The embodiment of change — managing it through death and rebirth. Few have seen The Spirit Ichida, and those that have rarely survive the experience with their sanity intact. Its Invisible City is said to sit at the very heart of Forestdown.",
    imageKey: null,
    imageUrl: null,
    active: true,
    order: 7,
