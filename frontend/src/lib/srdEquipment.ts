...
// Keyed by subclassId (lowercase, hyphenated, generated by toSlug(subclassName)).
// Two primary weapon IDs per subclass: one magic weapon matching the subclass's
// spellcast trait and one physical weapon matching the same trait (where available).
// These are editorial suggestions, not SRD mandates — any class can choose any weapon.

export const SUBCLASS_SUGGESTED_WEAPONS: Record<string, [string, string]> = {
  // ── Bard (Presence) ─────────────────────────────────────────────
  troubadour:                 ["scepter",          "cutlass"],
  wordsmith:                  ["scepter",          "rapier"],
  // ── Druid (Instinct) ───────────────────────────────────────────
  "warden-of-the-elements":  ["dualstaff",        "quarterstaff"],
  "warden-of-renewal":       ["hand-runes",       "quarterstaff"],
  // ── Guardian (Strength) ─────────────────────────────────────────
  stalwart:                   ["arcane-gauntlets", "warhammer"],
  vengeance:                  ["hallowed-axe",     "greatsword"],
  // ── Ranger (Agility) ───────────────────────────────────────────
  beastbound:                 ["glowing-rings",    "broadsword"],
  wayfinder:                  ["glowing-rings",    "longbow"],
  // ── Rogue (Finesse) ────────────────────────────────────────────
  nightwalker:                ["returning-blade",  "dagger"],
  syndicate:                  ["returning-blade",  "crossbow"],
  // ── Seraph (Strength) ──────────────────────────────────────────
  "divine-wielder":           ["hallowed-axe",     "mace"],
  "winged-sentinel":          ["arcane-gauntlets", "greatsword"],
  // ── Sorcerer (Instinct) ────────────────────────────────────────
  "elemental-origin":         ["hand-runes",       "dualstaff"],
  "primal-origin":            ["dualstaff",        "hand-runes"],
  // ── Warrior (Strength) ─────────────────────────────────────────
  "call-of-the-brave":        ["arcane-gauntlets", "battleaxe"],
  "call-of-the-slayer":       ["hallowed-axe",     "greatsword"],
  // ── Wizard (Knowledge) ─────────────────────────────────────────
  "school-of-knowledge":      ["wand",             "greatstaff"],
  "school-of-war":            ["greatstaff",       "wand"],
};
