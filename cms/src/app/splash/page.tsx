...
// Admin page for managing the campaign frame splash screen content.
...
export default function SplashPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError("");
    try {
      const data = await getAllItems("splash");
      setItems(data);
    } catch (err) {
      ...
      <div className="min-h-screen bg-brand-bg">
        ...
        <main className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-brand-light text-2xl font-bold">Campaign Splash Screen</h1>
            <button
          ...
          <p className="text-brand-muted text-sm mb-6">
            Intro text block shown during character creation. Typically a single active item.
          </p>
