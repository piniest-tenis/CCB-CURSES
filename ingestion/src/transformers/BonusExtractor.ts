...
//   hopeMax  → hopeMax
//
// Only flat numeric creation-time bonuses are extracted. Conditional effects
// (advantage, once-per-session, etc.) are not represented here.

import type { MechanicalBonus } from "@shared/types";
